//
//  RightNormalAlignedViewController.swift
//  fuchou
//
...
class RightNormalAlignedViewController: UIViewController ,UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
