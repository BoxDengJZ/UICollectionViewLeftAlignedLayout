...
- (BOOL)gestureRecognizerShouldBegin:(UIPanGestureRecognizer *)gestureRecognizer
{
    ...
    CGFloat maxAllowedInitialDistance = 60;
...
+ (void)load
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        Method deng_viewDidAppear_swizzledMethod = class_getInstanceMethod(self, @selector(deng_viewDidAppear:));
        method_exchangeImplementations(viewDidAppear_originalMethod, deng_viewDidAppear_swizzledMethod);
        ...
        Method viewDidDisappear_swizzledMethod = class_getInstanceMethod(self, @selector(deng_viewDidDisappear:));
...
- (void)fd_viewWillDisappear:(BOOL)animated
{
    ...
    [NSUserDefaults.standardUserDefaults setBool:false forKey: @"deng_viewDidAppear"];
...
- (void)deng_viewDidAppear:(BOOL)animated
{
    // Forward to primary implementation.
    [self deng_viewDidAppear:animated];
    [NSUserDefaults.standardUserDefaults setBool:YES forKey: @"deng_viewDidAppear"];
...
- (void)deng_viewDidDisappear:(BOOL)animated
{
    // Forward to primary implementation.
    [self deng_viewDidDisappear:animated];
    [NSUserDefaults.standardUserDefaults setBool:YES forKey: @"deng_viewDidAppear"];
